...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    'orbital.hint.mobile': 'Swipe to spin 3D constellation · Tap node to visit',
  ...
  id: {
    ...
    'orbital.hint.mobile': 'Geser layar untuk memutar konstelasi 3D · Ketuk titik untuk mengunjungi',
